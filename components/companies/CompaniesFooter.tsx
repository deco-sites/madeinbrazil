...
export default function CompaniesPage({
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between px-4 py-14 md:px-[102px] md:py-[100px] border-b-2 border-black border-opacity-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center p-4 md:px-[102px] md:pt-4 md:pb-7">
